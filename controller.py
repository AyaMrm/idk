...
class Controller:
    ...
    def keylogger_management_menu(self, client_id):
        ...
        while True:
            ...
            print("="*60)
            print("1. 🚀 Start Keylogger (Stealth Mode)")
            print("2. 🎯 Start Keylogger (Normal Mode)") 
            print("3. ⏹️  Stop Keylogger")
            print("4. 📊 Get Keylogger Status")
            print("5. 📁 Retrieve Recent Logs")
            print("6. 🗃️  Retrieve All Logs (Including Archived)")
            print("7. 🔙 Back to Process Menu")
